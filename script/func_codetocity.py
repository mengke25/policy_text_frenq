...
def code_to_city(df, city_variable):
    # 定义城市名和对应的城市代码
    city_codes = {
    ...
    "运城": 140800, "忻州": 140900, "临汾": 141000, "吕梁": 141100, "呼和浩特": 150100,
    "包头": 150200, "乌海": 150300, "赤峰": 150400, "通辽": 150500, "鄂尔多斯": 150600,
    "呼伦贝尔": 150700, "巴彦淖尔": 150800, "乌兰察布": 150900, "沈阳": 210100,
    ...
    "白城": 220800, "哈尔滨": 230100, "齐齐哈尔": 230200, "鸡西": 230300, "鹤岗": 230400,
    ...
    "海东": 630200, "银川": 640100, "石嘴山": 640200, "吴忠": 640300,
    "固原": 640400, "中卫": 640500, "乌鲁木齐": 650100, "克拉玛依": 650200, "吐鲁番": 650400,
    "哈密": 650500, "宜城": 420684, "喀什": 653101, "阿克苏": 652900, "楚雄": 532300,
    "大理": 532900, "恩施": 422800, "锡林郭勒": 152500, "玉树": 632700, "阿拉善": 152900,
    "阿勒泰": 654301, "昌吉": 652301, "临夏": 622900, "塔城": 654200, "文山": 532600,
    "和田": 653201, "大兴安岭": 232700, "延边州": 222400, "凉山": 513400, "黔西南": 522300,
    "黔南": 522700, "西双版纳": 532800, "德宏": 533100, "杨凌": 610403, "甘南": 623000,
    "海北": 632200, "海南藏": 632500, "海西": 632800, "巴音郭楞": 652800, "一师": 660100,
    "二师": 660200, "三师": 660300, "五师": 660500, "六师": 660600, "七师": 660700,
    "八师": 660800, "十师": 661000, "工师": 661100, "十二师": 661200, "十三师": 661300,
    "十四师": 661400, "兴安盟": 152200, "济源市": 419001, "神农架": 429021, "湘西": 433100,
    "黔东南": 522600, "红河": 532500, "怒江": 533300, "迪庆": 533400, "博尔塔拉": 652700,
    "克孜勒": 653000, "伊犁": 654002, "绥芬河": 231081, "果洛": 632600, "四师": 660400,
    "九师": 660900, "永城": 411400, "潜江": 429005, "阿坝": 513200, "甘孜州": 513300,
    "博州": 652700, "抚远县": 230833, "平潭综合实验区": 350128, "贵安新区": 550003,
    "仙桃": 429004, "梅河口": 220581, "天门": 429006
}
    ...
    for city, code in city_codes.items():
        if code in code_to_city:
            code_to_city[code].append(city)
        else:
            code_to_city[code] = [city]
    
    # 统一城市名
    for code in code_to_city:
        code_to_city[code] = "/".join(set(code_to_city[code]))

    # 创建新的 citycode 变量并初始化为0
    df['city_name'] = df[city_variable].map(code_to_city)
